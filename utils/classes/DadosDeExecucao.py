...
class DadosDeExecucao:
    ...
    def __init__(self, total_de_paginas: int, limite: int):
        self._hora_anterior: float = time()  # Sempre em UTC
        self._tempos_paginas: list = []  # Todas as fatias de tempo
        self._tempos_ciclos: list = []
    ...
    def _tempo_passado(self) -> float:
        """Soma de todos os valores de tempo coletados"""
